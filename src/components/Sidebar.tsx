...
const Sidebar = () => {
  ...
  const sidebarItem = [
    ...
    { title: "  Favoriten", icon: Heart },
    { title: " Text", icon: ChatbubbleEllipses },
    { title: " Programme", icon: Layers },
    { title: "Archiv", icon: FileTrayFull },
    { title: " Dokumenta", icon: DocumentText },
    { title: "Datum", icon: Calendar },
  ];
